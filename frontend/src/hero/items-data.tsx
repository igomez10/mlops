// @ts-nocheck
// items-data.tsx — ES-module port of design_handoff_ebay_operator/items-data.jsx
// Changes from source:
//   - window.PhotoTile / window.SUBJECTS removed; replaced with named exports
//   - REAL_DESK_PHOTO now uses an imported asset URL instead of a bare string path
...
const REAL_DESK_PHOTO = deskPhoto;
...
export { SUBJECTS, PhotoTile, REAL_DESK_PHOTO };
